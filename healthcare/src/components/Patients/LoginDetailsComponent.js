    ...
    render(){
        ...
        <div className="clearfix" style={{ "backgroundColor": "#d8d8d8" }}>
            <FormGroup>
                ...
                <Row ><Col><Label for="cpassword">Confirm Password</Label><Input type="password" name="cpassword" id="cpassword" onChange={(event) => { this.props.handleChange(event, 'cpassword') }} /></Col><Col></Col></Row>
            </FormGroup>
        </div>
        {/* </Form> */}
        </div>
